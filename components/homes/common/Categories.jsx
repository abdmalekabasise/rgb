  ...
  return (
    <section className="py-24">
      <div className="container">
        ...
        <div className="flex justify-center mt-12"><a className="bg-jacarta-100   dark:bg-jacarta-700 cursor-pointer group flex h-9 items-center rounded-lg border border-jacarta-100  px-4 font-display text-sm font-semibold text-jacarta-500 transition-colors hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600  dark:text-white dark:hover:border-transparent dark:hover:bg-accent dark:hover:text-white">Browse more games</a></div>
