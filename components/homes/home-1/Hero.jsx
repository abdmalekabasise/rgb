...
export default function Hero({ nonce }) {
  return (
        ...
        <div className="grid h-full items-center gap-4 md:grid-cols-12">
          <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-4">
            <h1 className="mb-6 text-center font-display text-5xl text-jacarta-700 dark:text-white md:text-left lg:text-6xl xl:text-7xl">
              Buy & sell Gaming Currencies and Services.
            </h1>
            <p className="mb-8 text-center text-lg dark:text-jacarta-200 md:text-left">
              EliteGameBoost is a digital marketplace for gaming services and currencies, including in-game items, skins, accounts, and boosting services. 
              We provide a safe and secure platform for gamers to buy, sell, and trade digital assets.
            </p>
