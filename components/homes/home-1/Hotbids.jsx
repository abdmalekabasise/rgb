...
export default function Hotbids({ nonce }) {
  const [allBids, setAllBids] = useState(bids);

  useEffect(() => {
    tippy("[data-tippy-content]", {
      placement: 'top', // Customize your tooltip placement
      theme: 'light', // Example of a custom theme
      arrow: true,
      nonce, // Pass the nonce for inline styles used by tippy.js
    });
  }, [nonce]);
