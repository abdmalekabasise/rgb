export default function Help({ nonce }) {
  return (
        ...
        <div className="items-center justify-between lg:flex lg:space-x-24">
          <div className="lg:w-[45%]">
            ...
            <p className="mb-6 text-lg dark:text-jacarta-300">
              Elite Boosts offers full game boosting services for all your gaming, and currency available for all the listed games.
            </p>
            <p className="dark:text-jacarta-300">
              We’ve integrated with our website to provide you with the best experience possible. If you have any questions or need help, please don’t hesitate to contact us.
            </p>
          </div>
