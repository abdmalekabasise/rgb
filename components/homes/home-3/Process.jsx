    ...
    <section className="relative py-24 dark:bg-jacarta-900">
      <div className="container">
        <h2 className="mb-16 text-center font-display text-3xl text-jacarta-700 dark:text-white">
          Create and sell your Game Services
        </h2>
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="text-center">
            ...
            <p className="dark:text-jacarta-300">
              Once you've set up your order of choice, contact us to get started.
          ...
          <div className="text-center">
            ...
            <p className="dark:text-jacarta-300">
              ...
              description, and customize your game service with properties, stats.
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="dark:text-jacarta-300">
              ...
              listings. You choose how you want to sell your game service!
            </p>
          </div>
        </div>
        ...
        <p className="mx-auto mt-20 max-w-2xl text-center text-lg text-jacarta-700 dark:text-white">
          ...
          releases, NFT drops, and tips and tricks for navigating EliteGameBoost
        </p>
