      ...
      <div className="container">
        ...
        <div className="article-content mx-auto max-w-[48.125rem]">
          ...
          <p>
            ...
            the EliteGameBoost website(s), our APIs, mobile app (the “App”), and any
          ...
          <p>
            EliteGameBoost is not a wallet provider, exchange, broker, financial
            institution, or creditor. EliteGameBoost provides a peer-to-peer web3
          ...
          <p>
            ...
            EliteGameBoost logo and all designs, text, graphics, pictures, data,
            software, sound files, other files, and the selection and
            arrangement thereof are the proprietary property of EliteGameBoost or our
          ...
          <p>
            These Terms constitute the entire agreement between you and EliteGameBoost
            ...
            assigned by you without the prior written consent of EliteGameBoost, and
            EliteGameBoost’s failure to assert any right or provision under these
          ...
          <p>
            ...
            applicable local laws. You and EliteGameBoost agree that the United
