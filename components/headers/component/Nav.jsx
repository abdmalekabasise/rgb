"use client";
import { userIsLoggedIn } from "@/data/api";
...
export default function Nav() {
  ...
  const [isLogged, setUser] = useState(userIsLoggedIn());
  ...
  return (
    <>
      ...
      <li className="js-nav-dropdown group relative">
        <a
          href="#"
          className={`dropdown-toggle flex items-center justify-between py-3.5 font-display text-base ${isActiveParentMenu(homes)
        ...
        >
          {homes.map((elm, i) => (
            <li key={i}>
              ...
              >
                <span
                  className={`mr-4 font-display text-sm ${elm.href == pathname
                    ? "text-accent dark:text-accent"
                    : "text-jacarta-700 dark:text-white"
                    }`}
                >
      ...
      <li className="js-nav-dropdown group relative">
        <a
          href="#"
          className={`dropdown-toggle flex items-center justify-between py-3.5 font-display text-base ${isActiveParentMenu(pages)
            ? "text-accent dark:text-accent"
            : "text-jacarta-700 dark:text-white"
            } hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent lg:px-5`}
          id="navDropdown-2"
        ...
        >
          {pages.map((elm, i) => (
            <li key={i}>
              ...
              >
                <span
                  className={`mr-4 font-display text-sm ${elm.href.split("/")[1] == pathname.split("/")[1]
                    ? "text-accent dark:text-accent"
                    : "text-jacarta-700 dark:text-white"
                    }`}
                >
      ...
      <li className="js-nav-dropdown group relative">
        <a
          href="#"
          className={`dropdown-toggle flex items-center justify-between py-3.5 font-display text-base ${isActiveParentMenu(resources)
            ? "text-accent dark:text-accent"
            : "text-jacarta-700 dark:text-white"
            } hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent lg:px-5`}
          id="navDropdown-4"
        ...
        >
          {resources.map((elm, i) => (
            <li key={i}>
              ...
              >
                <span
                  className={`font-display text-sm ${elm.href.split("/")[1] == pathname.split("/")[1]
                    ? "text-accent dark:text-accent"
                    : "text-jacarta-700 dark:text-white"
                    }`}
                >
      ...
      {!isLogged && <li className="group">
        <Link
          href="/login"
          className={`flex items-center justify-between py-3.5 font-display text-base ${"/login".split("/")[1] == pathname.split("/")[1]
            ? "text-accent dark:text-accent"
            : "text-jacarta-700 dark:text-white"
            } hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent lg:px-5`}
        >
